      ...
      <div class="collapse show" id="axe3">
        <div class="card-body">
          ...
          <div class="col-md-1 align-self-end ml-auto">
              <button type="button" class="btn btn-lg btn-info pull-right" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Teruskan</button>

              <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Masukan Nomor Agenda</h5>
