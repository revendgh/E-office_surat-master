            ...
            <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <?php $no++ ;?>
                        <tr>
                            <td>{{ $no }}</td>
                            <td><a href="{{ route(ARSIPARIS . '.keluar.create') }}">Surat Undangan INSPACE</a></td>
                            <td>Undangan</td>
                            ...
                            <td>
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                        <a href="{{ route(ARSIPARIS . '.keluar.create') }}" title="{{ trans('app.edit_title') }}" class="btn btn-primary btn-sm"><span class="ti-pencil"></span></a></li>
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        {!! Form::open([
                                            'class'=>'delete',
                                            'url'  => route(ARSIPARIS. '.keluar.destroy', 1),
                                            'method' => 'DELETE',
                                            ])
                                        !!}
