    ...
    <div class="card shadow mb-4">
      ...
      <div class="collapse show" id="axe3">
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-group col-md-8">
              {!! Form::mySelect('jenis_surat', 'Jenis Surat', config('variables.jenis_tata_naskah'), ['class' => 'form-control select2', 'required']) !!}
          ...
          <div class="form-group">
            <div class="form-group col-md-8">
              ...
              <div class="input-group mb-3">
              <input id="keperluan_surat" type="text" class="form-control @error('keperluan_surat') is-invalid @enderror" name="keperluan_surat" autocomplete="keperluan_surat" value="{{ old('keperluan_surat') }}" required>
              </div>
          ...
          <div class="form-group">
            <div class="form-group col-md-8">
              ...
              <div class="input-group mb-3">
              <input id="file_surat" type="file" class="form-control @error('file_surat') is-invalid @enderror" name="file_surat" autocomplete="file_surat">
              </div>
          ...
          <div class="form-group">
            <div class="form-group col-md-12">
              ...
              <div class="input-group mb-3">
              <input id="keterangan_surat" type="text" class="form-control @error('keterangan_surat') is-invalid @enderror" name="keterangan_surat" autocomplete="keterangan_surat" value="{{ old('keterangan_surat') }}" required>
              </div>
