...
@section('page-header')
    Lihat<small> Surat Keterangan Lulus</small>
@endsection
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-group col-md-12">
              ...
              <div class="input-group mb-3">
              <input id="keperluan" type="text" class="form-control @error('keperluan') is-invalid @enderror" name="keperluan" autocomplete="keperluan" value="{{ $surat->sk_lulus->keperluan}}" readonly>
              </div>
          ...
          <div class="form-group">
            <div class="form-group col-md-12">
              ...
              <div class="input-group mb-3">
              <input id="akreditasi_institut" type="text" class="form-control @error('akreditasi_institut') is-invalid @enderror" name="akreditasi_institut" value="{{ $surat->sk_lulus->akreditasi_institut}}" autocomplete="akreditasi_institut" readonly>
              </div>
          ...
          <div class="form-group">
            <div class="form-group col-md-6">
              ...
              <div class="input-group mb-3">
              <input id="tanggal_yudisium" type="text" class="form-control @error('tanggal_yudisium') is-invalid @enderror date datetimepicker" name="tanggal_yudisium" value="{{ $surat->sk_lulus->tanggal_yudisium}}" autocomplete="tanggal_yudisium" readonly>
              </div>
