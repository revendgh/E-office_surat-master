...
@section('page-header')
    Lihat<small> Surat Keterangan Aktif Organisasi</small>
@endsection
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="form-group col-md-12">
              ...
              <div class="input-group mb-3">
              <input id="organisasi" type="text" class="form-control @error('organisasi') is-invalid @enderror" name="organisasi" autocomplete="organisasi" value="{{ $surat->sk_aktif_organisasi->organisasi}}" readonly>
              </div>
          ...
          <div class="form-group">
            <div class="form-group col-md-12">
              ...
              <div class="input-group mb-3">
              <input id="jabatan" type="text" class="form-control @error('jabatan') is-invalid @enderror" name="jabatan" autocomplete="jabatan" value="{{ $surat->sk_aktif_organisasi->jabatan}}" readonly>
              </div>
          ...
          <div class="form-group">
            <div class="form-group col-md-12">
              ...
              <div class="input-group mb-3">
              <input id="keperluan" type="text" class="form-control @error('keperluan') is-invalid @enderror" name="keperluan" autocomplete="keperluan" value="{{ $surat->sk_aktif_organisasi->keperluan}}" readonly>
              </div>
          ...
          <div class="form-group row pl-3">
            <div class="form-group col-md-5">
                {!! Form::mySelect('semester', 'Semester', config('variables.semester'), $surat->sk_aktif_organisasi->semester, ['class' => 'form-control select2', 'readonly']) !!}
            </div>

            <div class="form-group col-md-5">
              <label for="tahun_akademik">Tahun Ajaran</label>
              <div class="input-group mb-3">
                <input id="tahun_akademik" type="text" class="form-control @error('tahun_akademik') is-invalid @enderror" name="tahun_akademik" autocomplete="tahun_akademik" value="{{ $surat->sk_aktif_organisasi->tahun_akademik}}" readonly>
              </div>
