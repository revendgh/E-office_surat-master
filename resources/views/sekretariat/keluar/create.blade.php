...
@section('content')
  ...
  <div class="col-md-9">
    ...
    <div class="card shadow mb-4">
      {!! Form::open([
          'route' => [ SEKRETARIAT. '.keluar.store' ],
          'files' => true
        ])
      !!}
      ...
      <div class="collapse show" id="axe3">
        <div class="card-body">
          ...
          <div class="col-sm-8">
              <a href="{{ route(SEKRETARIAT . '.keluar.index') }}" class="btn btn-lg btn-primary">Kembali</a>
          </div>
          <div class="col-sm-2">
          ...
          <div class="col-sm-2" style="text-align: right">
              <a href="" class="btn btn-lg btn-success form-control">Verifikasi</a>
          </div>
        </div>
          {!! Form::close() !!}
