            ...
            <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <?php $no++ ;?>
                        <tr>
                            <td>{{ $no }}</td>
                            <td><a href="{{ route(WAREKTOR . '.masuk.create') }}">UNIBA/SK/0112/08/2021</a></td>
                            ...
                            <td>
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                        <a href="{{ route(WAREKTOR . '.masuk.create') }}" title="{{ trans('app.edit_title') }}" class="btn btn-primary btn-sm"><span class="ti-pencil"></span></a></li>
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        {!! Form::open([
                                            'class'=>'delete',
                                            'url'  => route(WAREKTOR. '.masuk.destroy', 1),
                                            'method' => 'DELETE',
                                            ])
                                        !!}
